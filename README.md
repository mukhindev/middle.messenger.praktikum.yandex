Текущий Pull Request https://github.com/mukhindev-praktikum/middle.messenger.praktikum.yandex/pull/3
...
class Button extends Block {
  constructor(props: IButton) {
    ...
    super('button', {
      ...
      title: props.title ?? '',
      // Объект событий, названия соответсвуют названиям браузерных событий
      events: {
        // По клику вызывается функция onClick переданныя в props
        click: props.onClick,
      },
    });
  }
